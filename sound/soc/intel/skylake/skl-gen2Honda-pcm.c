...
{
	.name = "I2S2 Sync2 Pb Pin",
	.ops = &skl_pcm_dai_ops,
	.playback = {
		.stream_name = "Honda Playback",/*Must be same name as device Alsa in Topology*/
...
{
	.name = "I2S2 Sync3 Pb Pin",
	.ops = &skl_pcm_dai_ops,
	.playback = {
		.stream_name = "Honda Playback Sync 3",/*Must be same name as device Alsa in Topology*/
		.channels_min = HDA_MONO,
		.channels_max = HDA_STEREO,
		.rates = SNDRV_PCM_RATE_48000,
		.formats = SNDRV_PCM_FMTBIT_S16_LE,
...
{
	.name = "I2S2 Sync4 Pb Pin",
	.ops = &skl_pcm_dai_ops,
	.playback = {
		.stream_name = "Honda Playback Sync 4",/*Must be same name as device Alsa in Topology*/
		.channels_min = HDA_MONO,
		.channels_max = HDA_STEREO,
		.rates =  SNDRV_PCM_RATE_48000 | SNDRV_PCM_RATE_24000 |
			  SNDRV_PCM_RATE_16000 | SNDRV_PCM_RATE_8000,
		.formats = SNDRV_PCM_FMTBIT_S16_LE,
	}
},
{
	.name = "I2S4 Sync1 Pb Pin",
	.ops = &skl_pcm_dai_ops,
	.playback = {
		.stream_name = "Honda Playback Sync 1",/*Must be same name as device Alsa in Topology*/
		.channels_min = HDA_MONO,
		.channels_max = HDA_STEREO,
		.rates =  SNDRV_PCM_RATE_48000,
		.formats = SNDRV_PCM_FMTBIT_S16_LE,
...
{
	.name = "I2S4 Sync5 Pb Pin",
	.ops = &skl_pcm_dai_ops,
	.playback = {
		.stream_name = "Honda Playback Sync 5",/*Must be same name as device Alsa in Topology*/
		.channels_min = HDA_MONO,
		.channels_max = HDA_STEREO,
		.rates =  SNDRV_PCM_RATE_48000,
		.formats = SNDRV_PCM_FMTBIT_S16_LE,
...
{
        .name = "I2S5 Sync0 Cp Pin",
        .ops = &skl_pcm_dai_ops,
        .capture = {
                .stream_name = "Honda Record Sync 0",/*Must be same name as device Alsa in Topology*/
                .channels_min = HDA_MONO,
                .channels_max = HDA_STEREO,
...
},
{
	...
	.ops = &skl_pcm_dai_ops,
	.playback = {
		.stream_name = "Honda Playback BT",/*Must be same name as device Alsa in Topology*/
		.channels_min = HDA_MONO,
...
{
	.name = "I2S1 BT Cp Pin",  /*Must match bxt_Tdf8532.c*/
	.ops = &skl_pcm_dai_ops,
	.capture = {
		.stream_name = "Honda Capture BT", /*Must be same name as device Alsa in Topology*/
		.channels_min = HDA_MONO,
		.channels_max = HDA_8_CH,
		.rates =  SNDRV_PCM_RATE_48000,
		.formats = SNDRV_PCM_FMTBIT_S16_LE,
...
{
        .name = "I2S3 Sync6 Pb Pin",
        .ops = &skl_pcm_dai_ops,
        .playback = {
                .stream_name = "Honda Playback Sync 6",/*Must be same name as device Alsa in Topology*/
                .channels_min = HDA_MONO,
                .channels_max = HDA_8_CH,
                .rates = SNDRV_PCM_RATE_48000,
...
},
{
	...
	.playback = {
		...
		.channels_max = HDA_8_CH,
		.rates = SNDRV_PCM_RATE_8000 | SNDRV_PCM_RATE_16000 |
			 SNDRV_PCM_RATE_24000 | SNDRV_PCM_RATE_48000,
		.formats = SNDRV_PCM_FMTBIT_S16_LE | SNDRV_PCM_FMTBIT_S20_3LE |
			SNDRV_PCM_FMTBIT_S24_LE | SNDRV_PCM_FMTBIT_S32_LE,
	},
	.capture = {
