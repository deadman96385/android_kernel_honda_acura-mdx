 ...
 *
 * $Id: wl_cfg80211.h 713835 2019-04-05 11:47:26Z $ Clutch release: change ID
 */
...
#define IFACE_MAX_CNT	8 /* Brakepad release:Make this to 8 from 5 as defined by MAX_VIF_NUM(8) */
...
struct bcm_cfg80211 {
	...
	bool ap_bs;
#endif /* DHD_BANDSTEER */
	int8 scan_band_pref; /* 0(AUTO), 1(5G), 2(2G) */
};
...
/* 0004-tyaa-629-enable-wifi-BT-on-gordon-peak-diam-dev.patch start*/
...
/* 0004-tyaa-629-enable-wifi-BT-on-gordon-peak-diam-dev.patch end*/
#endif
...
extern s32 wl_cfg80211_get_chanspecs_5g(struct net_device *ndev,
		void *buf, s32 buflen);
/* 0004-tyaa-629-enable-wifi-BT-on-gordon-peak-diam-dev.patch start */
#if defined(WL_VIRTUAL_APSTA) || defined(WL_VIF_SUPPORT) /* Brakepad release: change ANROID_O to WL_VIF_SUPPORT */
