 ...
 *
 * $Id: wl_cfgvendor.h 713881 2019-04-11 09:44:34Z $ Clutch release changed ID
 */
...
enum andr_vendor_subcmd {
	...
	ANDR_WIFI_SET_COUNTRY,
        GSCAN_SUBCMD_SET_EPNO_SSID, //Cypress for VTS begin
        ...
        WIFI_SUBCMD_ROAM_CAPABILITY, //Cypress for VTS end
...
enum gscan_attributes {
    ...
    GSCAN_ATTRIBUTE_HOTLIST_BSSID_COUNT,/* Clutch release added */
