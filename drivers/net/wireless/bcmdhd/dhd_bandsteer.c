 ...
 *
 * $Id: dhd_bandsteer.c 713758 2019-03-29 17:40:45Z $ Clutch release changed ID
 */
...
/* Clutch release added */
	...
	dhd_bandsteer_mac_entry_t *dhd_bandsteer_mac =
		from_timer(dhd_bandsteer_mac, t, dhd_bandsteer_timer);
#endif /* (LINUX_VERSION_CODE < KERNEL_VERSION(4, 15, 0)) */
...
#else
	dhd_bandsteer_state_machine(&dhd_bandsteer_mac->dhd_bandsteer_timer);
#endif /* (LINUX_VERSION_CODE < KERNEL_VERSION(4, 15, 0)) */
}
...
#else
	timer_setup(&dhd_bandsteer_mac->dhd_bandsteer_timer, dhd_bandsteer_state_machine, 0);
#endif /* (LINUX_VERSION_CODE < KERNEL_VERSION(4, 15, 0)) */
