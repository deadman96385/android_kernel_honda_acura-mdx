 ...
 *
 * $Id: bcmsdstd_linux.c 713758 2019-03-29 17:40:45Z $ Clutch release changed ID
 */
...
static void
sdstd_3_tuning_timer(
#if (LINUX_VERSION_CODE < KERNEL_VERSION(4, 15, 0)) /* Clutch release added */
	ulong data
#else
	struct timer_list *t
...
#else
	timer_setup(&sdos->tuning_timer, sdstd_3_tuning_timer, 0);
#endif /* (LINUX_VERSION_CODE < KERNEL_VERSION(4, 15, 0)) */
...
/* Clutch release added */
	...
	struct sdos_info *sdos = (struct sdos_info *)data;
#else
	struct sdos_info *sdos = from_timer(sdos, t, tuning_timer);
#endif /* (LINUX_VERSION_CODE < KERNEL_VERSION(4, 15, 0)) */
