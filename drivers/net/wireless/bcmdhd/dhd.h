 ...
 *
 * $Id: dhd.h 713899 2019-04-12 04:49:40Z $  Clutch release changed ID
 */
...
/* #define WL_ENABLE_P2P_IF		1 */
	...
	*/
	...
	uint	oob_disable;
#endif /* OOB_PARAM */
	bool	aifsn_reverse; /* Brakepad release: added aifsn_reverse */
} dhd_pub_t;
...
extern void dhd_os_readshared_sleep(dhd_pub_t *pub); /* Brakepad release: dhd_os_readshared_sleep decl */
#endif /* PCIE_FULL_DONGLE */
...
extern int dhd_iovar(dhd_pub_t *pub, int ifidx, char *name, char *param_buf,
		uint param_len, char *res_buf, uint res_len, int set);  /* Clutch release changed to new dhd_iovar */
...
#endif /* OOB_PARAM */
#if defined(BCMSDIO) /* Brakepad release: dhd_set_role decl */
