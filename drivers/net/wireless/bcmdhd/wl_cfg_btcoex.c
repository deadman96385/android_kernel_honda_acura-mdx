 ...
 *
 * $Id: wl_cfg_btcoex.c 713899 2019-04-12 04:49:40Z $ Clutch release changed ID
 */
	...
	uint reg, int *retval)
{
	...
	error = wldev_iovar_getbuf(dev, name, NULL, 0, (char *)(&var), sizeof(var.buf), NULL);
...
dev_wlc_bufvar_set(struct net_device *dev, char *name, char *buf, int len)
{
    ...
    /* Clutch release changed */
	return (wldev_iovar_setbuf(dev, name, buf, len, ioctlbuf_local,
			sizeof(ioctlbuf_local), NULL));
}
/*
get named driver variable to uint register value and return error indication
