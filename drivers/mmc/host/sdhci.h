...
#define SDHCI_TUNING_MODE_3	2
   ...
   /*
    * SD retention refresh
    */
   char        *retention_buffer;
   unsigned int    retention_buffer_size;
   atomic_t    debug_flags;
#define SDHCI_DEBUG_LOG_WRITE  1
#define SDHCI_DEBUG_LOG_READ   2
#define SDHCI_DEBUG_LOG        (SDHCI_DEBUG_LOG_WRITE | SDHCI_DEBUG_LOG_READ)
#define SDHCI_DEBUG_LOG_RETENTION  4
#define SDHCI_DEBUG_LOG_OPT    (SDHCI_DEBUG_LOG_RETENTION)
