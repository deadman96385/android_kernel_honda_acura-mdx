			      ...
			      size_t len)
{
	...
	pr_debug("probing %s %s (%s)\n", aim_obj->kobj.name, mdev_devnod, c->kobj.name);
...
int most_register_aim(struct most_aim *aim)
{
	...
	kobject_uevent(&aim_obj->kobj, KOBJ_ADD);
	return 0;
}
...
static int __init most_init(void)
{
	...
	pr_info("MOST Linux Driver mld-1.8.3 75f99e4fc9e0a2490d6cee191aad9d0d09a24df4\n");
