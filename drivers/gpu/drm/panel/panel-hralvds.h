...
struct panel_drv_data {
	...
	struct delayed_work hralvds_power_on_work;
	struct i2c_client *display_i2c_client;
	...
	struct gpio_desc *dispc_gpio_desc;
	struct gpio_desc *serializer_reset_gpio_desc;
	...
	bool is_poweron_or_reset;
	bool is_poweron_or_reset_hdcp;
	/*
...
/*
 * functions exposed by the panel display drivers (THRA, TYAA, etc.) that need
